...
def get_args():
    ...
    parser.add_argument('--use_mlp_policy', type=bool, default=True, help='whether to use MlpPolicy')
    parser.add_argument('--custom_policy', type=str, default='', help='the custom policy to use (defaults to nothing and uses sb3 MlpPolicy)')
    ...
    parser.add_argument('--ys_map_range', type=int, default=30, help='the maximum number of traj_lengths for evaluation')
    parser.add_argument('--ys_sets_location', type=str, default='/opt/ys_sets', help='the number of RL interactions with the environment')
    ...
    parser.add_argument('--bidirectional', type=bool, default=False, help='whether the RNN is bidirectional')
