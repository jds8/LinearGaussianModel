...
def get_args():
    ...
    parser.add_argument('--ess_dims', type=list, default=[], help='dimensions for ess', nargs='*')
    ...
    # return it all
    return args, parser
'~/linear-gaussian-model/Aug-09-2022/rl_traj_length_10_dims_[1, 2, 3]_ESS_dim.csv'
